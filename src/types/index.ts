...
export interface Order {
  id: string;
  invoice_number?: string | null; // Invoice number in format PGC1M{day}D{orderNumber} (e.g., PGC1M17D1)
...
export interface CreateOrderData {
  ...
  member_id?: string;
  order_option?: 'order_via_messenger' | 'place_order';
  invoice_number?: string; // Invoice number in format PGC1M{day}D{orderNumber}
}
