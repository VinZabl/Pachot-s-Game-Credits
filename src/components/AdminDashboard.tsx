                                                            ...
                                                            <label className="flex items-center gap-2 cursor-pointer group">
                                                              <div className="relative flex items-center">
                                                                <input
                                                                  ...
                                                                  onChange={(e) => {
                                                                    updateVariation(variation.id, 'is_active', e.target.checked);
                                                                  }}
                                                              ...
                                                              <span className="text-[10px] font-medium text-gray-600 group-hover:text-gray-800 transition-colors">Available</span>
                                                            </label>
